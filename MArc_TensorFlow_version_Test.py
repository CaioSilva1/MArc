...
def lerImagens():    
    homem_files_path = 'homemmulher_ParaTestar/'
    mulher_files_path = 'homemmulher_ParaTestar/'
    ...
    with tf.Session() as sess:
        ...
        for i in range(5000):
            ...
            if len(homem_files)==0:
                homem_files, mulher_files = lerImagens() 
                batch_imgs, labels = lerBatchImagens(140, homem_files, mulher_files);
            else:
                batch_imgs, labels = lerBatchImagens(140, homem_files, mulher_files);
            ...
            print('epoch %d, Treinamento accuracy %g, learning rate: %g' % (i/5, train_accuracy, learning_rate_decaying))
        ...
        print('\n# TESTE  #')
        print('Teste accuracy %g' % accuracy.eval(feed_dict={x: batch_imgs, y_: labels, keep_prob: 1.0}))
